...
const Projects = () => {
  return (
    <>
      <h2
        className="font-bold text-4xl md:text-4xl mt-4 font-text text-center "
        id="projects"
      >
        PROJECTS
      </h2>
                ...
                {item.hasDemo && (
                  <span>
                    <a href={item.link1} target="_blank" rel="noreferrer">
                      <button className="bg-green dark:bg-gradient-to-l from-purple to-pink py-2 px-6 text-white rounded">
                        Demo &nbsp;{" "}
                        <svg
                    ...
                    <a href={item.link2} target="_blank" rel="noreferrer">
                      <button className="bg-secColor dark:bg-gradient-to-r from-purple to-pink mx-2 md:mx-4 mt-3 text-white  py-2 px-6 rounded">
                        Github{" "}
                      </button>
                    </a>
                  </span>
